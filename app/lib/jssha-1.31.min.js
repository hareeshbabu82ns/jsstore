var charSize = 8, b64pad = "", hexCase = 0, Int_64 = function (a, b) {
  this.highOrder = a;
  this.lowOrder = b
}, str2binb = function (a) {
  ...
  var a = rotr_64(x, 28), rotr34 = rotr_64(x, 34), rotr39 = rotr_64(x, 39);
  ...
  var a = rotr_64(x, 14), rotr18 = rotr_64(x, 18), rotr41 = rotr_64(x, 41);
  ...
  var a = rotr_64(x, 1), rotr8 = rotr_64(x, 8), shr7 = shr_64(x, 7);
  ...
  var a = rotr_64(x, 19), rotr61 = rotr_64(x, 61), shr6 = shr_64(x, 6);
  ...
  var e = (a & 0xFFFF) + (b & 0xFFFF) + (c & 0xFFFF) + (d & 0xFFFF), msw = (a >>> 16) + (b >>> 16) + (c >>> 16) + (d >>> 16) + (e >>> 16);
...
jsSHA.prototype = {getHash: function (a, b) {
  var c = null, message = this.strToHash.slice();
  switch (b) {
    case"HEX":
      c = binb2hex;
      break;
  ...
  var e, keyToUse, blockByteSize, blockBitSize, i, retVal, lastArrayIndex, keyBinLen, hashBitSize, keyWithIPad = [], keyWithOPad = [];
  switch (d) {
    case"HEX":
      e = binb2hex;
      break;
